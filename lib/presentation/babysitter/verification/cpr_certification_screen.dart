...
class CprCertificationScreen extends ConsumerStatefulWidget {
  const CprCertificationScreen({super.key});

  @override
  ConsumerState<CprCertificationScreen> createState() => _CprCertificationScreenState();
}

class _CprCertificationScreenState extends ConsumerState<CprCertificationScreen> {
  ...
  Future<void> _submitCertification() async {
    if (_certificate == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please upload your CPR certificate first.')),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('CPR certification submitted successfully.'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('CPR Certification')),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Upload CPR Certificate', style: Theme.of(context).textTheme.headlineSmall),
            const SizedBox(height: AppSizes.sm),
            Text(
              'Submit a valid CPR certificate to earn the CPR badge on your profile.',
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        isApproved
                            ? 'CPR certification approved.'
                            : 'CPR certification is under review.',
            ...
            if (!isUnderReview && !isApproved)
              ElevatedButton(
                ...
                child: _isSubmitting
                    ...
                    : const Text('Submit CPR Certification'),
              ),
